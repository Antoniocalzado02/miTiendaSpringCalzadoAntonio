...
--
-- Base de datos: `miTiendaSpringCalzadoAntonio`
--
...
(1, 'Cemento', 'Fluid Waste Treatment'),
(2, 'Arcilla', 'Construction Aids'),
(3, 'Aislante', 'Basic Electrical Materials and Methods'),
(4, 'Pegamento', 'Darkroom Equipment'),
(5, 'Granito', 'Construction Aids'),
(6, 'Marfil', 'Cold-Formed Metal Framing'),
(7, 'Ladrillos', 'Unit Kitchens'),
(8, 'Pegamento aislante', 'Rough Grading'),
(9, 'Material de suelos', 'Temporary Telephone'),
(10, 'Material de baños', 'Masonry Units');
